...
class TestConvertToLoiteringDailyEvents:
    ...
    def test_convert_to_loitering_daily_events(self):
        ...
        assert result == {
            ...
            "end_lat": -20.174042,
            "end_lon": 148.89871,
            "loitering_end_timestamp": dt.datetime(
                2023, 10, 28, 1, 14, 54, tzinfo=dt.timezone.utc
            ),
            "loitering_hours": 23.725277777777777,
            "loitering_start_timestamp": dt.datetime(
                2023, 10, 28, 0, 14, 54, tzinfo=dt.timezone.utc
            ),
            "seg_id": "503040990-2023-10-27T00:31:23.000000Z-1",
            "ssvid": "503040990",
            "start_lat": -20.174032,
